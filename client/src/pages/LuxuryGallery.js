        ...
        <div className="container px-6 py-8 mx-auto">
            <div className="lg:flex lg:-mx-2">
                <div className="space-y-3 lg:w-1/5 lg:px-2 lg:space-y-4">
                    <Link to="/luxurygallery/jacketcoats" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Jackets & Coats</Link>
                    <Link to="/luxurygallery/hoodies" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Hoodies</Link>
                    <Link to="/luxurygallery/tshirtsvests" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">T-shirts & Vests</Link>
                    <Link to="/luxurygallery/shirts" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Shirts</Link>
                    <Link to="/luxurygallery/blazerssuits" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Blazers & Suits</Link>
                    <Link to="/luxurygallery/jeans" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Jeans</Link>
                    <Link to="/luxurygallery/trousers" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Trousers</Link>
                    <Link to="/luxurygallery/shorts" className="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Shorts</Link>
                </div>
