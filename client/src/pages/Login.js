        ...
        <form onSubmit={onSubmitHandler}>
            <div className="flex flex-col mb-2">
                <div className="flex relative ">
                    ...
                    <input type="email" value={Email} onChange={onEmailHandler} id="sign-in-email" className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-transparent" placeholder="Your email"/>
                    </div>
                </div>
                <div className="flex flex-col mb-6">
                    ...
                    <div className="flex w-full">
                        <button type="submit" className="py-2 px-4  bg-black hover:bg-black focus:ring-gray-500 focus:ring-offset-gray-600 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                            Login
                        </button>
                    </div>
                </form>
