...
const ReviewDetail = () => {
    ...
    return (
        <div className="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
            <div id="viewerBox" className="lg:p-10 md:p-6 p-4 bg-white border-2">
                <div className="mt-3 md:mt-4 lg:mt-0 flex flex-col lg:flex-row items-strech justify-center lg:space-x-8">
                    ...
                    <div className="lg:w-1/2 h-1/2 flex flex-col justify-center mt-7 md:mt-8 lg:mt-0 pb-8 lg:pb-0">
                        <div>
                            <p className="text-base leading-normal text-gray-600 ">{/**상품명 */}상품명</p>
                            <h1 className="text-3xl lg:text-4xl font-semibold text-gray-800 ">{review.title}</h1>
                            <p className="text-base leading-normal text-gray-600  mt-2">{review.content}</p>
                        </div>
